            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={i} className="flex gap-4 group">
                                    <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 text-accent group-hover:bg-accent/10 transition-colors">
                    ...
                    >
                        ...
                        <div className="relative aspect-square rounded-[3rem] border border-white/10 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-3xl overflow-hidden group">
                            ...
                            <div className="absolute bottom-10 left-10 right-10">
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
                                    <p className="text-white font-medium italic text-lg mb-2 text-balance">"True innovation happens where legacy structures end and sovereign imagination begins."</p>
