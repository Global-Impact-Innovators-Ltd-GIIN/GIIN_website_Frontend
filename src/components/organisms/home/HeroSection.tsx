  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-background">
      ...
      >
        ...
        >
          <span className="mb-4 inline-block rounded-full border border-primary/30 bg-primary/10 px-4 py-1.5 text-sm font-medium text-primary backdrop-blur-md">
            The Future of African Innovation
          </span>
        </motion.div>
        
        <motion.h1 
          className="mb-6 font-heading text-5xl font-extrabold tracking-tight sm:text-7xl md:text-8xl lg:text-9xl bg-clip-text text-transparent bg-gradient-to-br from-white to-white/40"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
