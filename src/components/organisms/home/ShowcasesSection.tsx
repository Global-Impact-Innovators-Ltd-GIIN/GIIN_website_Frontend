          ...
          <div key={index} className="flex flex-col space-y-12">
            ...
            >
              <div>
                ...
                <h2 className="mt-2 font-heading text-4xl font-bold md:text-5xl text-foreground">{showcase.title}</h2>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {showcase.items.map((item, i) => (
                <motion.div
                  key={i}
                  className="group relative aspect-[4/3] overflow-hidden rounded-2xl bg-card border border-border/10 p-8 flex items-end cursor-pointer shadow-sm hover:shadow-xl transition-all duration-500"
                ...
                >
                  ...
                  <h4 className="relative z-10 text-2xl font-black text-foreground group-hover:text-primary transition-colors tracking-tight">{item}</h4>
                </motion.div>
              ))}
            </div>
          </div>
