                    ...
                    <div className="lg:col-span-8 space-y-8">
                            ...
                            <div className="bg-card/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-8">
                                ...
                                <div className="space-y-4 text-sm">
                                    <div className="flex justify-between border-b border-white/5 pb-2">
                                        ...
                                        <span className="font-black text-2xl text-primary font-mono">{(loan?.principalAmount || app.requestedAmount).toLocaleString()} RWF</span>
                                    </div>
                                    <div className="flex justify-between border-b border-white/5 pb-2">
                                        <span className="text-muted-foreground">Term Requested</span>
                                        <span className="font-bold text-white uppercase">{loan?.durationWeeks || app.requestedDuration} Week(s)</span>
                                    </div>
                                    <div className="flex justify-between">
                        ...
                        <div className="bg-card/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                                ...
                                <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5">
                                    <span className="text-[9px] font-black uppercase text-muted-foreground tracking-widest block mb-1">Claimed Market Value</span>
                        ...
                        <div className="bg-card/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-10">
                            ...
                            <div className="space-y-6">
                                {loan?.activityLogs?.map((log: any, i: number) => (
